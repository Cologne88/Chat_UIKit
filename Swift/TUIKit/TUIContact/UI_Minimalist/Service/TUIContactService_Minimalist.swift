...
public class TUIContactService_Minimalist: NSObject, TUIServiceProtocol {
    ...
    @objc public class func swiftLoad() {
        TUISwift.tuiRegisterThemeResourcePath(TUISwift.tuiBundlePath("TUIContactTheme_Minimalist", key: TUIContactBundle_Key_Class), themeModule: TUIThemeModule.contact)
