...
public class TUIConversationService_Minimalist: NSObject {
    @objc public class func swiftLoad() {
        TUISwift.tuiRegisterThemeResourcePath(TUISwift.tuiBundlePath("TUIConversationTheme_Minimalist", key: TUIConversationBundle_Key_Class), themeModule: TUIThemeModule.conversation_Minimalist)
    }
