...
final class TUIAttributedLabelAccessibilityElement: UIAccessibilityElement {
...
extension TUIAttributedLabel {
    ...
    func configureAccessibilityElements() {
        ...
        var elements: [TUIAttributedLabelAccessibilityElement] = []
        var actions: [UIAccessibilityCustomAction] = []

        let baseElement = TUIAttributedLabelAccessibilityElement(accessibilityContainer: self)
