    ...
    private func drawBackground(_ frame: CTFrame, inRect rect: CGRect, context: CGContext) {
        ...
        for line in lines {
            ...
            for glyphRun in glyphRuns {
                ...
                let strokeColor: UIColor? = attributes[.TUIAttributedLabelBackgroundStrokeColor] as? UIColor
                let fillColor: UIColor? = attributes[.TUIAttributedLabelBackgroundFillColor] as? UIColor
                let fillPadding: UIEdgeInsets = attributes[.TUIAttributedLabelBackgroundFillPadding] as? UIEdgeInsets ?? .zero
                let cornerRadius: CGFloat = attributes[.TUIAttributedLabelBackgroundCornerRadius] as? CGFloat ?? 0.0
                let lineWidth: CGFloat = attributes[.TUIAttributedLabelBackgroundLineWidth] as? CGFloat ?? 0.0
    ...
    private func drawStrike(frame: CTFrame, inRect: CGRect, context: CGContext) {
        ...
        for line in lines {
            ...
            for glyphRun in glyphRuns {
                ...
                guard let strikeOut = attributes[.TUIAttributedLabelStrikeOut] as? Bool, strikeOut else {
                    continue
                }
