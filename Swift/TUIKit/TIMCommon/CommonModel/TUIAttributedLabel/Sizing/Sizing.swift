...
extension TUIAttributedLabel {
    ...
    override open func sizeThatFits(_ size: CGSize) -> CGSize {
        ...
        let labelSize = TUIAttributedLabel.suggestFrameSize(for: string, framesetter: framesetter, withSize: size, numberOfLines: numberOfLines)
        // add textInsets?
    ...
    public static func sizeThatFitsAttributedString(_ attributedString: NSAttributedString?, withConstraints constraints: CGSize, limitedToNumberOfLines: Int) -> CGSize {
        ...
        return TUIAttributedLabel.suggestFrameSize(for: attributedString, framesetter: framesetter, withSize: constraints, numberOfLines: limitedToNumberOfLines)
    }
