...
@IBDesignable open class TUIAttributedLabel: UILabel {
    ...
    open weak var delegate: TUIAttributedLabelDelegate?
    ...
    open var enabledTextCheckingTypes: NSTextCheckingResult.CheckingType = [] {
        didSet {
            ...
            let preBuiltDataDetector = TUIAttributedLabel.dataDetectorsByType[enabledTextCheckingTypes.rawValue]
            ...
            do {
                ...
                TUIAttributedLabel.dataDetectorsByType[enabledTextCheckingTypes.rawValue] = detector
                dataDetector = TUIAttributedLabel.dataDetectorsByType[enabledTextCheckingTypes.rawValue]
            } catch {
    ...
    open var linkBackgroundEdgeInset: UIEdgeInsets = .init(top: 0, left: -1, bottom: 0, right: -1)
    ...
    /// defaults to .center
    open var verticalAlignment: TUIAttributedLabel.VerticalAlignment = .center
    ...
    private static var dataDetectorsByType: [UInt64: NSDataDetector] = [:]
    ...
    var activeLink: TUIAttributedLabel.Link? {
        didSet {
    ...
    var linkModels: [TUIAttributedLabel.Link] = []
    ...
    /// Use this setter when you want to set attributes on TUIAttributedLabel before setting attributedText and have the properties get copied over
    /// This will overwrite properties set on the attributedString passed in, if they're set on TUIAttributedLabel. Use `attributedText` if you want
