...
extension TUIAttributedLabel {
    public typealias LinkTappedBlock = ((TUIAttributedLabel, TUIAttributedLabel.Link) -> Void)
    ...
    public struct Link: Equatable {
        ...
        public var linkTappedBlock: TUIAttributedLabel.LinkTappedBlock?
        public var result: NSTextCheckingResult?
        public var text: String?

        public init(attributes: [NSAttributedString.Key: Any]?, activeAttributes: [NSAttributedString.Key: Any]?, inactiveAttributes: [NSAttributedString.Key: Any]?, linkTappedBlock: TUIAttributedLabel.LinkTappedBlock?, result: NSTextCheckingResult?, text: String?) {
        ...
        public init(label: TUIAttributedLabel, result: NSTextCheckingResult?, text: String?) {
        ...
        public static func == (lhs: TUIAttributedLabel.Link, rhs: TUIAttributedLabel.Link) -> Bool {
    ...
    /// Adds a single link
    public func addLink(_ link: TUIAttributedLabel.Link) {
        addLinks([link])
    }

    /// Adds a link to a `url` with a specified `range`
    @discardableResult
    public func addLink(to url: URL, withRange range: NSRange) -> TUIAttributedLabel.Link? {
        return addLinks(with: [.linkCheckingResult(range: range, url: url)], withAttributes: linkAttributes).first
    }

    @discardableResult
    private func addLinks(with textCheckingResults: [NSTextCheckingResult], withAttributes attributes: [NSAttributedString.Key: Any]?) -> [TUIAttributedLabel.Link] {
        var links: [TUIAttributedLabel.Link] = []
        ...
        for result in textCheckingResults {
            ...
            let link = TUIAttributedLabel.Link(attributes: attributes, activeAttributes: activeLinkAttributes, inactiveAttributes: inactiveLinkAttributes, linkTappedBlock: nil, result: result, text: text)
            links.append(link)
        }
    ...
    private func addLinks(_ links: [TUIAttributedLabel.Link]) {
    ...
    private func link(at characterIndex: Int) -> TUIAttributedLabel.Link? {
    ...
    ///
    /// returns nil if there's no link
    public func link(at point: CGPoint) -> TUIAttributedLabel.Link? {
    ...
    func didSetActiveLink(activeLink: TUIAttributedLabel.Link?, oldValue: TUIAttributedLabel.Link?) {
