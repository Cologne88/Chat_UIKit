...
@objc protocol TUIMenuViewDelegate: NSObjectProtocol {
    @objc optional func menuViewDidSelectItemsAtIndex(_ menuView: TUIMenuView, _ index: Int)
    @objc optional func menuViewDidSendMessage(_ menuView: TUIMenuView)
}

class TUIMenuView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    var menuCollectionView: UICollectionView!
    var menuFlowLayout: UICollectionViewFlowLayout!
    weak var delegate: TUIMenuViewDelegate?
    ...
    func setupViews() {
        ...
        menuCollectionView.register(TUIMenuCell.self, forCellWithReuseIdentifier: TMenuCell_ReuseId)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.row % 2 == 0 {
            if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TMenuCell_ReuseId, for: indexPath) as? TUIMenuCell {
