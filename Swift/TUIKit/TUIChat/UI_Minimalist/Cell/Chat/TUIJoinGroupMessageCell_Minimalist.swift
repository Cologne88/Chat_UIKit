...
@objc protocol TUIJoinGroupMessageCellDelegate_Minimalist: AnyObject {
    @objc optional func didTapOnNameLabel(_ cell: TUIJoinGroupMessageCell_Minimalist)
    @objc optional func didTapOnSecondNameLabel(_ cell: TUIJoinGroupMessageCell_Minimalist)
    @objc optional func didTapOnRestNameLabel(_ cell: TUIJoinGroupMessageCell_Minimalist, withIndex index: Int)
}

class TUIJoinGroupMessageCell_Minimalist: TUISystemMessageCell, UITextViewDelegate {
    var joinData: TUIJoinGroupMessageCellData?
    weak var joinGroupDelegate: TUIJoinGroupMessageCellDelegate_Minimalist?
    ...
    override open func fill(with data: TUICommonCellData) {
        ...
        let attributeDict: [NSAttributedString.Key: Any] = [
            ...
            NSAttributedString.Key.foregroundColor: messageLabel.textColor as Any,
            NSAttributedString.Key.backgroundColor: messageLabel.backgroundColor as Any,
