Pod::Spec.new do |spec|
  spec.name         = 'TUIGroupNotePlugin_Swift'
  spec.module_name  = 'TUIGroupNotePlugin'
  ...
  spec.summary      = 'TUIGroupNotePlugin_Swift'
  spec.requires_arc = true
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuiplugin/8.6.7019/ios/TUIGroupNotePlugin_Swift_8.6.7019.xcframework.zip'}
