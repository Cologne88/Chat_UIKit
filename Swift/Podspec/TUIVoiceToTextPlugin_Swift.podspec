Pod::Spec.new do |spec|
  ...
  spec.subspec 'UI' do |commonUI|
    commonUI.subspec 'DataProvider' do |dataProvider|
      dataProvider.source_files = '**/TUIVoiceToTextPlugin/UI/DataProvider/*.{h,m,mm,swift}'
      dataProvider.dependency "TUIVoiceToTextPlugin_Swift/CommonModel"
    end
    commonUI.subspec 'UI' do |subUI|
      subUI.source_files = '**/TUIVoiceToTextPlugin/UI/UI/*.{h,m,mm,swift}'
      subUI.dependency "TUIVoiceToTextPlugin_Swift/UI/DataProvider"
    end
    commonUI.subspec 'Service' do |service|
      service.source_files = '**/TUIVoiceToTextPlugin/UI/Service/*.{h,m,mm,swift}'
      service.dependency "TUIVoiceToTextPlugin_Swift/UI/UI"
    end
