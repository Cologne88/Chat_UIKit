Pod::Spec.new do |spec|
    spec.name         = 'TUIConversationGroupPlugin_Swift'
    spec.module_name  = 'TUIConversationGroupPlugin'
    ...
    spec.summary      = 'TUIConversationGroupPlugin_Swift'
    
    spec.requires_arc = true
  
    spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuiplugin/8.6.7019/ios/TUIConversationGroupPlugin_Swift_8.6.7019.xcframework.zip'}
