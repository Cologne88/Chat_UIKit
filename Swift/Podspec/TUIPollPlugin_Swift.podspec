Pod::Spec.new do |spec|
  ...
  spec.summary      = 'TUIPollPlugin_Swift'
  
  spec.requires_arc = true

  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuiplugin/8.6.7019/ios/TUIPollPlugin_Swift_8.6.7019.xcframework.zip'}
